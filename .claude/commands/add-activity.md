...
3. Add a new `if (condition) steps.Add(...)` block. The condition should check something from the `DiffReport r` (e.g. `r.Pct < 100`, missing uniques, under-rolled affixes, open sockets).
